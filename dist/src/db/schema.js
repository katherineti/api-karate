...
exports.kataPerformancesTable = exports.scoringDivisionsTable = exports.modalitiesTable = exports.eventsTable = exports.subtypesEventsTable = exports.typesEventsTable = exports.usersTable = exports.karateBeltsTable = exports.karateCategoriesTable = exports.schoolTable = exports.roleTable = exports.statusTable = exports.eventStatus_scheduled = void 0;
...
exports.scoringDivisionsTable = (0, pg_core_1.pgTable)("scoring_divisions", {
    id: (0, pg_core_1.serial)("id").primaryKey(),
    event_id: (0, pg_core_1.integer)("event_id")
        .notNull()
        .references(() => exports.eventsTable.id),
    karate_category_id: (0, pg_core_1.integer)("karate_category_id")
        .notNull()
    ...
    phase: (0, pg_core_1.varchar)("phase", { length: 100 }).notNull().default('Clasificación'),
    is_active: (0, pg_core_1.boolean)("is_active").notNull().default(true),
    created_at: (0, pg_core_1.timestamp)("created_at").defaultNow(),
    updated_at: (0, pg_core_1.timestamp)("updated_at").defaultNow(),
}, (table) => {
    return [
        (0, pg_core_1.unique)("unique_modality_per_event").on(table.event_id, table.karate_category_id, table.modality_id),
    ];
});
exports.kataPerformancesTable = (0, pg_core_1.pgTable)("kata_performances", {
    ...
    scoring_division_id: (0, pg_core_1.integer)("scoring_division_id")
        .notNull()
        .references(() => exports.scoringDivisionsTable.id),
