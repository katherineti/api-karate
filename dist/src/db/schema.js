...
exports.tournamentRegistrationsTable = (0, pg_core_1.pgTable)("tournament_registrations", {
    ...
    status: (0, pg_core_1.varchar)("status", { length: 50 }).default('Solicitud Pendiente').notNull(),
    ...
    payment_status: (0, pg_core_1.varchar)("payment_status", { length: 50 }).default('Pendiente por pagar').notNull(),
